...
class ReactForm extends React.Component {
  ...
  constructor(props) {
    ...
    // console.log(props.answer_data,"constructor")
  ...
  _getDefaultValue(item) {
    console.log(this.answerData, "incomingans")
  ...
  _getItemValue(item, ref, trimValue) {
    ...
    if (item.element === 'Rating') {
      ...
      $item.value = ref.inputField.current.state.ratingCache.rating;
      ...
      $item.value = ref.inputField.current.lastValueProp;
    ...
    if (item.element === 'Checkboxes' || item.element === 'RadioButtons') {
      ...
      item.options.forEach(option => {
        ...
        if ($option.checked) {
          ...
          checked_keys.push(option.key);
        }
      });
      // debugger
      itemData.value = checked_options;
      itemData.key = checked_keys;
    } else {
      if (!ref) return null;
      // debugger
