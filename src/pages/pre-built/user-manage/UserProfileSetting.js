  ...
  return (
    <React.Fragment>
      ...
      <Content>
                      ...
                      <div className="between-center flex-wrap g-3">
                        ...
                        <div className="nk-block-actions flex-shrink-sm-0">
                          <ul className="align-center flex-wrap flex-sm-nowrap gx-3 gy-2">
                            <li className="order-md-last">
                              <Button onClick={() => togglePasswordModal()} color="primary">Change Password</Button>
                            </li>
                            {/* <li>
        ...
        <Modal isOpen={passwordModal} size="sm" toggle={togglePasswordModal}>
          <ChangePassword toggle={togglePasswordModal} />
        </Modal>
      </Content>
    </React.Fragment>
  );
